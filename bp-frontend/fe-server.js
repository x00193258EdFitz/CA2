...
var body =  '</head><body><div id="container">' +
				 ...
				 '<label class="control-label">changed here Email</label>' +
...
var submitButton = '<button class="button button1">Submit</button>' +
				   '</div></form>' +
				 	'<div id="version">  version ' + global.gConfig.version;
...
http.createServer(function (req, res) {
	...
	if (req.method === 'POST') {
		collectFormData(req, result => {
			...
			console.log(global.gConfig.webservice+result.systolic+'/'+result.diastolic+'/'+result.email)
